...
<head>
	<meta charset="utf-8" />
	<title>Ats Sport | Création d'une épreuve</title>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed gradient-enabled">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="active">Création d'une épreuve</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Création d'une épreuve</h1>
			<!-- end page-header -->
<?php 
...
//echo "totot".$_SESSION["log_id"]; 
		...
		if (isset($_POST['epre_id']) || isset($_GET['epre_id']))
		{
			if (isset($_POST['epre_id']))
			{
				...
				$query .= "e.referencer, e.urlImage, e.dateInscription, e.paiement_cb, e.payeur, e.cout_paiement_cb, e.devisChrono, e.administrateur, e.CMPCOD_FFA , e.webservice_FFTRI, cat_annee, e.insc_dossard_dernier, e.insc_aff_place_restante, e.periode_reversement_inscriptions, e.chrono_ats_sport,e.webService_Atlas, ";
									...
									<!-------------------------->
										...
										<div class="form-group">
												...
												<?php if($admin==1)  { ?>
													...
													<div class="form-group">
														<label class="col-md-4 control-label">Epreuve avec Webservice Atlas</label>
														<div class="">
															<div class="form-inline col-md-2">
																<select class="form-control" name="epre_webservice_Atlas">
																	<OPTION VALUE="non" > Non </OPTION>
																	<OPTION VALUE="oui"<?php if ($f->Atlas =='oui') echo "selected"; else echo ""; ?> > Oui </OPTION>
																</select>
															</div>
															<div class="form-inline" id="aff_Atlas">
																<label class="control-label">RaceID</label>
																<input class="input-inline form-control" id="epre_CMPCOD_FFA" name="epre_race_ID" type="text"  class="form-control" placeholder="" />
															</div>
														</div>
													</div>															
													<div class="form-group">
												...
												<input type="hidden" value="<?php echo $_SESSION["typeInternaute"]; ?>" name="typeInternaute">
