...
<head>
	<meta charset="utf-8" />
	<title>ATS-SPORT | Chronométrage - Vidéo - Inscription en ligne - Dossards et plaque de cadre - Communication</title>
	<meta content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" name="viewport" />
	<meta content="ATS-SPORT - Chronométrage - Vidéo - Inscription en ligne - Dossards et plaque de cadre - Communication name="description" />
                                    ...
                                    <td class="wrapper">
                                        <table class="twelve columns">
                                                ...
                                                <td class="">
													<table class="btn primary" align="center">
                                                        <tbody>
															<tr>
																<td>
																	<a href="'.$lien_request_mdp.'"><b> Cliquez ici pour changer votre mot de passe </b></a>
																</td>
															</tr>
														</tbody>
													</table>
											...
											<table align="center">				
															<tr >
																<td>
																	<p><i>Ceci est un mail générique</i></p>
																	<p><i>'.$info_agent.'</i></p>
																</td>
															</tr>
											</table>
...
';
	...
	return $css.$entete_email.$corps2.$corps3;
