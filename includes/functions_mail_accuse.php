...
if (!empty($donnees[0]['infoParcoursInscription'])) { 
   ...
   $info_complementaires_parcours = '<tr>
                                        <td style="padding: 5px; border: 3px  solid #cc4946;margin-bottom:10px">
											<p class="x_info-danger" style="text-align:center;">'.$donnees[0]['infoParcoursInscription'].'</p>
                                        </td>
                                     </tr>';
}
//print_r($donnees);//accuse_reception$accuse_reception='';if ($donnees[0]['accuse_reception']=='oui') {		$accuse_reception = '</b> et votre accusé de réception en pièce jointe</b>';}
...
$lien_edition = 'http://www.ats-sport.com/inscriptions.php?id_epreuve='.$donnees[0]['idEpreuve'].'&id_parcours='.$donnees[0]['idParcours'].'&id='.$donnees[0]['idSession'].'&date_inscription='.$donnees[0]['dateInscription'].'&action=update&id_int='.$idEpInscInt;
$lien_inscrits = 'http://www.ats-sport.com/liste_des_inscrits.php?id_epreuve='.$donnees[0]['idEpreuve'];
                        ...
                        <table class="twelve columns">
                            <tr>
                                <td class="last">
                                    ...
                                    <h5 >Résumé de vos informations '.$accuse_reception.'</h5>
                                </td>
                            </tr>
                        </table>
                                            ...
                                            <tr>
                                                <td>
													...
													<ul class="info">
														...
														<li><strong>Prénom :</strong> <em>'.$donnees[0]['prenomInternaute'].'</em></li>
...
*/														$corps .= '<li><strong>Mode de Paiement :</strong> <em>'.$donnees[0]['mode_paiement'].'</em></li>
                                ...
                                <tr>
                                    ...
                                    <td class="wrapper">
										...
										'.$info_complementaires_parcours.'
                                            ...
                                            <tr>
                                                <td class="">
													<table class="btn primary" align="center" style="margin-top: 10px;">
                                                        <tbody>
															<tr>
																<td>
                                    ...
                                    <tr>
                                        <td class="wrapper">
                                            <table class="six columns">
                                                <tr>
                                                    <td>
                                                        &copy; Ats Sport 2020 - Powered by ATS-SPORT.
                                                    </td>
                                                    <td class="expander"></td>
                                                </tr>
                                            </table>
