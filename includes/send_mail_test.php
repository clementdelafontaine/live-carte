...
while (($row=mysqli_fetch_array($result)) != FALSE) {
	...
	$mail_send = send_mail ('contact@pointcourse.com','Ats Sport Inscription',$row['emailInternaute'], $row['nomInternaute']." ".$row['prenomInternaute'], $sujet,$corps,"jf@chauveau.nom.fr");
	if ($mail_send == 'ok') {
...
//****$mail_send = send_mail ('contact@pointcourse.com','Ats Sport Inscription',$value['email'], $value['nom']." ".$value['prenom'], $sujet,$corps,"jf@chauveau.nom.fr"); */
