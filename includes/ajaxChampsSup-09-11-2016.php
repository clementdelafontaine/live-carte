<?php 
	...
	if ($_GET['id_parcours'] !=0) {
		...
		$champ_questiondiverse = array ('id' => 'idChampsSupQuestionDiverse', 'nom' =>'nom', 'label'=>'label', 'critere'=>'critere', 'unite'=>'unite', 'type_champ'=>'type_champ','date_butoir'=>'date_butoir', 'obligatoire'=>'obligatoire', 'ordre'=>'ordre');
