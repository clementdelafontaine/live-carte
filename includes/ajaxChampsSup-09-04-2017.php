<?php 
	...
	function limite_age ($id_parcours,$update,$type_epreuve) {
			...
			if ($type_epreuve==1 || $_GET['id_epreuve']==4185) {
	...
	if ($_GET['id_parcours'] !=0) {
		...
		//******MODIF********
		$champ_questiondiverse = array ('id' => 'idChampsSupQuestionDiverse', 'nom' =>'nom', 'label'=>'label', 'critere'=>'critere', 'unite'=>'unite', 'type_champ'=>'type_champ','date_butoir'=>'date_butoir', 'obligatoire'=>'obligatoire', 'ordre'=>'ordre', 'verifie'=>'verifie', 'date_verifie'=>'date_verifie');
		//******MODIF********
		...
		while($row_questiondiverse = mysqli_fetch_array($result_questiondiverse))
		{
				...
				$champ_row_questiondiverse['id_file_record'] = '';
